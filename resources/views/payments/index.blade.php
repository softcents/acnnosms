                                ...
                                <div class="payment-list-table">
                                    ...
                                    <table class="table table-striped">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ __('Plan Price') }}</td>
                                                <td>{{ currency_format(round(convert_money($plan->price, $gateway->currency)), currency: $gateway->currency) }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ currency_format(round(convert_money($plan->price, $gateway->currency) + $gateway->charge), currency: $gateway->currency) }}</td>
                                            </tr>
