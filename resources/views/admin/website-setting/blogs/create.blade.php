                                            ...
                                            <div class="col-12 mb-2">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row row-items">
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    <input type="text" name="tags[]" class="form-control" required placeholder="{{ __('Enter tags name') }}">
                                                                </div>
                                                                <div class="col-sm-2 align-self-center mt-3">
                                                                    <button type="button" id="first-delete-btn" class="btn text-danger trash remove-btn-features" disabled>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 mt-2">
                                                        <a href="javascript:void(0)" class="fw-bold text-primary add-new-tag" onclick="addDynamicField()">
