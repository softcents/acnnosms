                            ...
                            <div class="add-suplier-modal-wrapper">
                                <div class="row">
                                    <div class="col-lg-6 mt-2">
                                        ...
                                        <input type="text" name="satisfy_about" required class="form-control" placeholder="{{ __('Enter Satisfy About') }}" >
                                    </div>
                                    ...
                                    <div class="col-lg-6 mt-2">
                                        ...
                                        <input type="file" name="client_image" required class="form-control" >
                                    </div>
