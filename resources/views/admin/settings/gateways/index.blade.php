            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-4 mb-4">
                    <ul class="nav nav-pills flex-column flex-column shadow w-280 p-2">
                        ...
                        <li class="nav-item">
                            <a href="#{{ str_replace(' ', '-', $gateway->name) }}" id="{{ str_replace(' ', '-', $gateway->name) }}-tab4" @class(['add-report-btn nav-link', 'active' => $loop->first ? true : false]) data-bs-toggle="tab">{{ $gateway->name }}</a>
                        </li>
                        @endforeach
                    </ul>
                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 mb-2">
                                                ...
                                                <select class="form-control" required name="currency_id">
                                                    ...
                                                    <option @selected($gateway->currency_id == $currency->id) value="{{ $currency->id }}">{{ $currency->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-12 mb-2">
                                                ...
                                                <select class="form-control" required name="mode">
                                                    <option @selected($gateway->mode == 'Sandbox') value="Sandbox">{{ __('Sandbox') }}</option>
                                                    <option @selected($gateway->mode == 'Live') value="Live">{{ __('Live') }}</option>
                                                </select>
                                            </div>
                                            @endif
                                            ...
                                            <div class="col-12 mb-2 {{ $gateway->is_manual ? '' : 'd-none' }}">
                                                ...
                                                <select class="form-control" required name="accept_img">
                                                    <option @selected($gateway->accept_img == 1) value="1">{{ __('Yes') }}</option>
                                                    <option @selected($gateway->accept_img == 0) value="0">{{ __('No') }}</option>
                                                </select>
                                            </div>
                                                    ...
                                                    <div class="row row-items">
                                                        ...
                                                        <div class="col-sm-5">
                                                            ...
                                                            <select class="form-control" required name="manual_data[is_required][]">
                                                                <option @selected($gateway->manual_data['is_required'][$key] == 1) value="1">{{ __('Required') }}</option>
                                                                <option @selected($gateway->manual_data['is_required'][$key] == 0) value="0">{{ __('Optional') }}</option>
                                                            </select>
                                                        </div>
