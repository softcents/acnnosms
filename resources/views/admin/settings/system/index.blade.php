                ...
                <div class="tab-content order-summary-tab mt-0">
                    <div class="tab-pane fade active show" id="add-new-petty" role="tabpanel">
                        ...
                        <div class="table-header">
                            <div class="card-body">
                                <div class="table-header mb-0 border-0">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-12 col-md-8">
                                            <div class="cards border-0 shadow">
                                                <div class="card-body">
                                                    <form action="{{ route('admin.system-settings.store') }}" method="post" class="ajaxform_instant_reload">
                                                        @csrf
                                                        ...
                                                        <div class="tab-content no-padding">
                                                            ...
                                                            <div class="tab-pane fade" id="mail-configuration">
                                                                ...
                                                                <span>{{ __('QUEUE COMMAND Path :') }} <span class="text-danger">{{ __('/home/u186958312/domains/smspro.acnoo.com/public_html/smspro') }}</span></span><br>
