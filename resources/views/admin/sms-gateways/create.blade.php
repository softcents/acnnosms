                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="add-new-user">
                            ...
                            <div class="order-form-section">
                                <form action="{{ route('admin.sms-gateways.store') }}" method="post" class="ajaxform_instant_reload">
                                    @csrf
                                    ...
                                    <div class="add-suplier-modal-wrapper">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 mb-2">
                                                ...
                                                <input type="number" step="any" name="priority" class="form-control" placeholder="{{ __('Enter gateway priority here') }}">
                                            </div>
