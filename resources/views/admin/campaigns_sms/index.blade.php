            ...
            <div class="card shadow-sm">
                <div class="card-bodys p-16">
                    ...
                    <div class="table-top-form">
                        ...
                        <form action="{{ route('admin.campaigns_sms.index') }}" method="post">
                            @csrf
                ...
                <div class="responsive-table">
                    <table class="table" id="datatable">
                        ...
                        <tbody class="searchResults">
                            @include('admin.campaigns_sms.datas')
                        </tbody>
                    </table>
                </div>
                <nav>
                    <ul class="pagination">
                        <li class="page-item">{{ $campaign_sms->links('pagination::bootstrap-5') }}</li>
                    </ul>
                </nav>
            </div>
        </div>
