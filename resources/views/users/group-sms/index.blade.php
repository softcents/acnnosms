                                ...
                                <form action="{{ route('users.group-sms.store') }}" method="post" class="ajaxform_instant_reload">
                                    ...
                                    <div class="add-suplier-modal-wrapper">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 mt-4">
                                                <div class="gpt-up-down-arrow position-relative">
                                                    <select name="group_id" required="" class="form-control select-dropdown">
