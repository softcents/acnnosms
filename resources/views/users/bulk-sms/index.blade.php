                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 mt-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 align-self-center">
                                                        <a href="{{ route('users.download-numbers-file') }}" class="theme-btn print-btn text-light w-100">
